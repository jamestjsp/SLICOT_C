 ...
 * If row_major=0, lda >= max(1,n) (rows). If row_major=1, lda >= max(1,n) (columns).
 * @param[in] b         Double array, dimension (ldb, m) or (n, ldb). The input matrix B.
 * @param[in] ldb       The leading dimension of array B.
 * If row_major=0, ldb >= max(1,n) (rows). If row_major=1, ldb >= max(1,m) (columns).
 ...
 * @param[in] ldf       The leading dimension of array F.
 * If row_major=0, ldf >= max(1,m) (rows). If row_major=1, ldf >= max(1,n) (columns).
 ...
 * If row_major=0, ldz >= max(1,n) (rows). If row_major=1, ldz >= max(1,n) (columns).
