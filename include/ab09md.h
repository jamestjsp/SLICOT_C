/**
 * @file ab09md.h
 * @brief C wrapper for SLICOT routine AB09MD
 *
 * This file provides a C interface to the SLICOT routine AB09MD,
 ...
 */
 ...
 /**
  * @brief Balance & Truncate model reduction for the ALPHA-stable part of a system.
  *
  ...
  * The original A, B, C arrays are overwritten.
  *
  ...
  * (block diagonal with unstable and reduced stable parts).
