/**
 * @file sb04md.h
 * @brief C wrapper for SLICOT routine SB04MD
 *
 * This file provides a C interface to the SLICOT routine SB04MD,
 ...
 */
 ...
 /**
  * @brief Solves the continuous-time Sylvester equation AX + XB = C.
  *
  * Uses the Hessenberg-Schur method. A is reduced to upper Hessenberg form H,
  * B' is reduced to real Schur form S. The transformed equation HY + YS' = F
