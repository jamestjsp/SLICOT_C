 ...
 * 
 * AB01OD converts a state-space system (A,B) to "staircase" form, which
 * reveals the controllable and uncontrollable parts of the system.
 * The transformation can be performed in two stages:
 * - Forward stage: reduction to orthogonal canonical form
 * - Backward stage: further reduction to triangular form
 */
